...
class CharterPlayBar extends UIComponent {
    ...
    public function new(x:Float = 0, y:Float = 0) {
        ...
        goBackToStartButton = new Button(0, 0, "|<", 34, 26);
        ...
        goBackAMeasureButton = new Button(0, 0, "<<", 34, 26);
        ...
        playPauseButton = new Button(0, 0, ">", 34, 26);
        ...
        goForwardAMeasureButton = new Button(0, 0, ">>", 34, 26);
        ...
        goToEndButton = new Button(0, 0, ">|", 34, 26);
