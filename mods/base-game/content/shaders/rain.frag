// taken from https://github.com/Stilic/FNF-LOVE/blob/1.0.1/assets/shaders/rain.frag
// the shader from funkin itself is really hard to figure out
// and i can't be bothered to do that honestly
