...
function onLoadPost()
    ...
    for i, char in ipairs(chars) do
        ...
        char.onDraw = function(spr)
            ...
            spr.position.y = spr.position.y + ((spr.animation:getBiggestFrameHeight() * 0.98) + spr.reflectionOffY)
            spr:_draw()
    ...
    props.opponent.reflectionOffY = -90
    props.player.reflectionOffY = -120
